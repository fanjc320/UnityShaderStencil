...
Shader "Unlit/CreateCircle"
{
	Properties
	{
		...
		//_MainTex("Albedo (RGB)", 2D) = (0,0,0,0)
	}
		...
		Pass
	{
		...
		////Tags {"Queue" = "Transparent"}//完全透明，看不到
		//Blend SrcAlpha OneMinusSrcAlpha

		////Tags { "RenderType" = "Opaque"} //fjc
		//Tags { "RenderType" = "Transparent"} //fjc
		// 
		//ZWrite On
		//ZTest Always
		...
		////	}
		////	else {
		////		return fixed4(0,0,0,0); //可能还是清空效果 ; 运行起来是黑色
		////	}
		////	return c;
		////	}
		////ENDCG
